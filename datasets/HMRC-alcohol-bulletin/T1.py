...
# +
f1=(df['Alcohol Origin'] =='Over 15% \nABV')
df.loc[f1,'Alcohol by Volume'] = 'Over 15% ABV'

f2=(df['Alcohol by Volume'] =='£ million')
df.loc[f2,'Unit'] = 'GBP Million'

f3=(df['Revision'] =='P')
df.loc[f3,'Marker'] = 'provisional'

f4=(df['Revision'] =='R')
df.loc[f4,'Marker'] = 'revised'

df = df.replace({'Alcohol Origin' : {'Over 15% \nABV' : 'all', 'Ex-\nwarehouse' :'Ex-Warehouse', 'Total1 \nWine' : 'Total Wine' }})
