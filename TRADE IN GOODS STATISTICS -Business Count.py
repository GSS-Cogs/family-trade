...
# +
# new_table['HMRC Industry'] = new_table['HMRC Industry'].str.rstrip('1234567890')
...
# new_table['HMRC Industry'] = new_table['HMRC Industry'].map(lambda cell:cell.replace('tal8', 'NA'))
