...
Final_table['Revision'] = Final_table.apply(lambda row: user_perc8(row['Period'],row['Revision']), axis = 1)
# -
...
# Final_table.to_csv(destinationFolder / ('hmrcalcohol_3.csv'), index = False)
# -
